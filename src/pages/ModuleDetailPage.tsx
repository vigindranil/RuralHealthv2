      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-extrabold text-blue-900 mb-2 drop-shadow">
            {pageTitle} <span className="text-lg font-medium text-blue-500">(Jalpaiguri)</span>
          </h1>
          ...
          <div className="overflow-x-auto">
            {tableData.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="mt-1 text-sm text-gray-500">There is no data available for this indicator.</p>
              </div>
            )}
          </div>
        </div>
