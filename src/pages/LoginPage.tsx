...
export default function LoginPage() {
  ...
  const roleConfig = {
    'GP': {
      ...
      fullDescription: 'Village-level health data collection and monitoring',
    ...
    'Health Centre': {
      ...
      fullDescription: 'Primary healthcare facility management and oversight',
    ...
    'ICDS Centre': {
      ...
      fullDescription: 'Integrated Child Development Services management',
    ...
    'District Admin': {
      ...
      fullDescription: 'District-wide health administration and policy oversight',
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="space-y-1 text-sm text-gray-600">
                ...
                <p className="text-green-600 font-medium">✓ Works for all user roles</p>
              </div>
            </div>
          </div>
